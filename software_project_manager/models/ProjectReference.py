...
class ProjectReference(db.Model):
    ...
    # TODO: Add SoftwareProject relationship!!

    def __init__(self, name, reference_type_id, url=None, author_name=None):
        self.name = name
        self.reference_type_id = reference_type_id
        self.url = url
        self.author_name = author_name
    
    def update(self, new_name, new_reference_type_id, new_url, new_author_name):
        self.name = new_name
